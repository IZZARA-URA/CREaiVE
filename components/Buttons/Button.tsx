...
const ButtonPrimaryKeepHover = 'w-full h-[50px] rounded-[20px] font-SanFrancisco text-lg font-bold uppercase bg-black text-white border-white border-2 hover:bg-white hover:text-black'
