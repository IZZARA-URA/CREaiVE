    ...
    <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="col-span-1">
            <div className="pt-[25vh]">
              <Image
                src={`${direction}/Rise of the AI Humans.png`}
      ...
      <div className="h-auto">
        <Header
          ...
          tagline={[
            "Our tools can be helpful for your business, and make the impact to customers interacted make the choices.",
          ]}
        />
          ...
          <div className="grid grid-cols-12 gap-4 items-center text-center mx-2">
            <div className="w-full h-[600px] col-span-5 bg-grayDefaultDark-400 rounded-[20px] overflow-hidden">
              <video loop preload="none" muted autoPlay>
                <source
                  src={`${direction}/videos/Snap finger cloth change.mp4`}
                  type="video/mp4"
                />
              </video>
            </div>
              ...
              <div className="grid grid-cols-3 gap-4 max-h-[300px] h-full pb-2">
                <div className="col-span-1 bg-grayDefaultDark-0 rounded-[20px] h-full overflow-hidden">
                  <img
                    ...
                    src={`${direction}/aihumansNisa.png`}
                    alt="Placeholder"
                  />
                </div>
                ...
                <div className="col-span-2 bg-grayDefaultDark-100 rounded-[20px] h-full overflow-hidden">
                  <video loop preload="none" muted autoPlay>
                    <source
                      src={`${direction}/videos/AiHumans.mp4`}
                      type="video/mp4"
                    />
                  </video>
                </div>
            ...
            <div className="w-full h-[600px] col-span-5 bg-grayDefaultDark-400 rounded-[20px] overflow-hidden">
              ...
              >
                <source
                  ...
                  src={`${direction}/videos/ThairathVideo.mp4`}
                  type="video/mp4"
                />
              </video>
            </div>
            ...
            <div className="w-full h-[600px] col-span-7">
              ...
              <div className="grid grid-cols-1 gap-4 max-h-[300px] h-full pt-2">
                <div className="col-span-2 bg-grayDefaultDark-0 rounded-[20px] h-full overflow-hidden">
                  ...
                  >
                    <source
                      src={`${direction}/videos/UsecaseFaceSwap.mp4`}
                      type="video/mp4"
                    />
                  </video>
                </div>
          ...
          <div className="grid grid-cols-3 gap-2 mt-2 h-auto">
            <div className="relative w-full h-full bg-grayDefaultDark-200 rounded-[20px] text-white overflow-hidden">
              <CardImage
                ...
                image={`${direction}/AihimanNisa.png`}
                href="/ai-humans"
              />
            </div>
          ...
          >
            <div className="flex w-full gap-4 justify-around opacity-80">
              <img
                ...
                src={`${direction}/logos/Customers Logo 06.png`}
                alt="Placeholder"
              />
              <img
                className="w-[100px] h-[100px] rounded-[20px]"
                src={`${direction}/logos/Customers Logo 07.png`}
                alt="Placeholder"
              />
              <img
                className="w-[100px] h-[100px] rounded-[20px]"
                src={`${direction}/logos/Customers Logo 08.png`}
                alt="Placeholder"
              />
              <img
                className="w-[100px] h-[100px] rounded-[20px]"
                src={`${direction}/logos/Customers Logo 09.png`}
                alt="Placeholder"
              />
              <img
                className="w-[100px] h-[100px] rounded-[20px]"
                src={`${direction}/logos/Customers Logo 10.png`}
                alt="Placeholder"
              />
            </div>
            {/*  */}
            <div className="flex w-full gap-4 justify-around opacity-80">
              <img
                className="w-[100px] h-[100px] rounded-[20px]"
                src={`${direction}/logos/Customers Logo 01.png`}
                alt="Placeholder"
              />
              <img
                className="w-[100px] h-[100px] rounded-[20px]"
                src={`${direction}/logos/Customers Logo 02.png`}
                alt="Placeholder"
              />
              <img
                className="w-[100px] h-[100px] rounded-[20px]"
                src={`${direction}/logos/Customers Logo 03.png`}
                alt="Placeholder"
              />
              <img
                className="w-[100px] h-[100px] rounded-[20px]"
                src={`${direction}/logos/Customers Logo 04.png`}
                alt="Placeholder"
              />
              <img
                className="w-[100px] h-[100px] rounded-[20px]"
                src={`${direction}/logos/Customers Logo 05.png`}
                alt="Placeholder"
              />
            </div>
          </CardsScreenTrustedBy>
              ...
              <div className="relative">
                <div className="flex  w-full justify-center m-auto py-auto">
                  ...
                  <div className="w-full h-full text-center justify-center py-2">
                    <GrLocation
                      className="w-full items-center justify-center m-auto"
                      size={50}
                    />
                    <div className="text-[16px] font-bold">Office</div>
                  ...
                  <div className="w-full h-full text-center justify-center py-2">
                    ...
                    <div className="text-[12px]">hello@creaive.ai</div>
                  </div>
                  {/*  */}
                  <div className="w-full h-full text-center justify-center py-2">
                    <FaPhoneVolume
                    ...
                    <div className="text-[14px] py-2">Talk to us</div>
                    <div className="text-[12px]">Tel: (+66) 089-765-7654</div>
                  </div>
                </div>
              </div>
            </Cards>
